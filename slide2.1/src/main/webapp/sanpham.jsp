              ...
              <div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							...
							<jsp:param value="anh1.jpg" name="img"/>
						</jsp:include>
					</div>
		      </div>
				...
				<div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							...
							<jsp:param value="anh2.jpg" name="img"/>
						</jsp:include>
					</div>
				</div>
				<div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							...
							<jsp:param value="anh3.jpg" name="img"/>
						</jsp:include>
					</div>
				</div>
				<div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							...
							<jsp:param value="anh4.jpg" name="img"/>
						</jsp:include>
					</div>
				</div>  
				...
				<div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							<jsp:param value="Product 4" name="name"/>
							<jsp:param value="anh5.jpg" name="img"/>
						</jsp:include>
					</div>
				</div> 
				<div class="item">
					<div class="item_item">
						<jsp:include page="item.jsp" >
							<jsp:param value="Nguyễn Văn a" name="name"/>
							<jsp:param value="nguyenvana.jpg" name="img"/>
						</jsp:include>
					</div>
				</div>                
